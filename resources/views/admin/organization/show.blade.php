...
@section('content')
    ...
    @include('includes.leading-title', ['title' => $organization->organization . ' ( ' . $organization->books->count() . ' )'])

    @if($organization->books->count() > 0)
        <div class="row">
            @foreach($organization->books->chunk(4) as $books)
